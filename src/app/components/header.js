"use client";
import { Bars4Icon, HeartIcon, ShoppingCartIcon } from "@heroicons/react/24/solid";
    ...
    return(
        <div className="z-50 fixed w-[414px] h-[52px] grid grid-cols-3 px-3 py-3 justify-between text-[#333736] text-lg font-semibold bg-[#FFFFFF] shadow-sm">
          ...
          <div className="flex justify-end items-center space-x-5">
            <button onClick={() => router.push("/pages/favorite")} className="h-[25px] w-[25px] ">
              <HeartIcon className="fill-[#333736]" />
            </button>
            <button onClick={() => router.push("/pages/cart")} className="h-[25px] w-[25px]">
